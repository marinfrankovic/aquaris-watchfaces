(() => {
  ...
  document.querySelector('[data-nav="installation"]').href = '#installation';
  document.querySelector('[data-nav="disclaimer"]').href = '#disclaimer';
